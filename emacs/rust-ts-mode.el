  ...
  (treesit-font-lock-rules
   ...
   `((scoped_use_list path: (identifier) @font-lock-constant-face)
     ...
     ((use_list (identifier) @font-lock-type-face)
       (:match "\\`[A-Z]" @font-lock-type-face))
      ;; Lowercase imports (modules/crates) use constant-face.
   ...
   '((arguments (identifier) @font-lock-variable-use-face)
     ...
     ;; ---- Custom additions: highlight missing identifiers ----
     ;; Highlight identifiers inside index expressions, e.g. arr[i]
     (index_expression (identifier) @font-lock-variable-use-face)

     ;; Highlight identifiers inside macro token trees
